...
describe('ONE-2014: Credential design', () => {
  ...
  // Fail. Skip as still a bug with mDoc design
  describe.skip('ONE-2395: Credential Layout mDoc', () => {
    ...
    // Bug. Not all attributes from list displayed
    it('Test credential card attributes', async () => {
      await CredentialDetailScreen.credentialCard.verifyAttributeValues(
        [
          { index: '0.0', key: 'Address/country', value: 'CH' },
          { index: '0.1', key: 'Address/region', value: 'Zurich' },
          { index: '0.2', key: 'Address/city', value: 'Zurich' },
          { index: '0.3', key: 'Address/street', value: 'strasse' },
          { index: '1.0', key: 'Credentials/first name', value: 'Wade' },
          { index: '1.1', key: 'Credentials/last name', value: 'Wade' },
          { index: '1.2', key: 'Credentials/Birthday', value: '1/17/2018' },
          { image: true, index: '1.3', key: 'Credentials/image' },
          // { index: '2.0', key: 'Data/Categories/Category', value: 'A' },
        ],
        CredentialDetailScreen.scrollTo,
      );
    ...
    // Bug. No image, no qr code and carousel
    it('Test credential carousel', async () => {
      await CredentialDetailScreen.credentialCard.verifyImageIsVisible(
        CarouselImageType.Photo,
      );
